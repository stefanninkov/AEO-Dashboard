          ...
          {aiSummary && (
            <div className="card" style={{
              ...
              <div style={{ marginBottom: '1rem' }}>
                <p style={{ fontSize: '0.6875rem', color: 'var(--text-tertiary)', marginBottom: '0.25rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.0313rem' }}>{'Key Insight'}</p>
                <p style={{ fontSize: '0.8125rem', color: 'var(--text-primary)', lineHeight: 1.6 }}>{aiSummary.keyInsight}</p>
              </div>
              <div>
                <p style={{ fontSize: '0.6875rem', color: 'var(--text-tertiary)', marginBottom: '0.25rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.0313rem' }}>{'Opportunity'}</p>
              ...
              {analysis?.timestamp && (
                <p style={{ fontSize: '0.6875rem', color: 'var(--text-disabled)', marginTop: '1rem' }}>
                  {'Last analysis'}: {new Date(analysis.timestamp).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric', hour: '2-digit', minute: '2-digit' })}
                </p>
              )}
            </div>
          )}
