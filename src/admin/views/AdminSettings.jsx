...
import { Settings, Shield, Bell, Globe, Database, Copy, Check } from 'lucide-react'
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
        ...
        <SettingSection icon={Globe} title="Platform">
          ...
          <Toggle label="Allow New Signups" checked={signupsEnabled} onChange={setSignupsEnabled} />
          <div style={{
            ...
            These toggles are UI previews only. To persist settings, connect to a Firestore `config` collection.
          </div>
        </SettingSection>

        {/* Notifications */}
        <SettingSection icon={Bell} title="Notifications">
          <Toggle label="Email on new signups" checked={emailNotifications} onChange={setEmailNotifications} />
          <div style={{
            padding: '0.625rem 0.75rem',
            borderRadius: '0.5rem',
            background: 'rgba(245,158,11,0.08)',
            ...
            Email notifications require a Cloud Function or third-party service (SendGrid, Resend, etc.).
          </div>
        </SettingSection>
